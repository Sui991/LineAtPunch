...
namespace TT.Models
{
 ...
 PunchRecord_Table tbl_punch { get; set; }
        ...
        public override string ToString()
        {
            ...
            return String.Format("address: {0},notes:: {1},img:{2},A_ID:{3},type:{4},id:{5},datetime:{6}", tbl_punch.punch_addr, tbl_punch.punch_notes, tbl_punch.punch_img, tbl_punch.punch_employeeID, tbl_punch.punch_type, tbl_punch.punch_id, tbl_punch.punch_datetime);
        }
